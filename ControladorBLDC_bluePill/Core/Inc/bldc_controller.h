...
#define BLDC_CURRENT_1_PIN     ((uint16_t)CURRENT_1_PIN)
#define BLDC_CURRENT_2_PIN     ((uint16_t)CURRENT_2_PIN)
#define BLDC_CURRENT_3_PIN     ((uint16_t)CURRENT_3_PIN)
...
#define BLDC_LED_PIN         ((uint16_t)LED_PIN)
	...
	#define BLDC_CURRENT_1_HANDLER     ((ADC_HandleTypeDef *)STM_CURRENT_1_HANDLER)
	#define BLDC_CURRENT_2_HANDLER     ((ADC_HandleTypeDef *)STM_CURRENT_2_HANDLER)
	#define BLDC_CURRENT_3_HANDLER     ((ADC_HandleTypeDef *)STM_CURRENT_3_HANDLER)

	#define BLDC_PWM_A_HANDLER       ((TIM_HandleTypeDef *)STM_PWM_A_HANDLER)
    #define BLDC_PWM_B_HANDLER_L     ((TIM_HandleTypeDef *)STM_PWM_B_HANDLER_L)
	#define BLDC_PWM_B_HANDLER_H     ((TIM_HandleTypeDef *)STM_PWM_B_HANDLER_H)
